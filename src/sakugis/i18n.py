...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    ...
    "about.body": {
        ZH_CN: "<h3>SakuGIS 0.1.0</h3><p>一款基于 QGIS 的轻量 macOS 桌面 GIS。</p><p>开发团队：<a href=\"https://urbancomp.net\">UrbanComp</a>。</p><p>许可证：GNU GPL v2 或更高版本。</p>",
        EN: "<h3>SakuGIS 0.1.0</h3><p>A lightweight macOS desktop GIS powered by QGIS.</p><p>Developed by the <a href=\"https://urbancomp.net\">UrbanComp team</a>.</p><p>License: GNU GPL v2 or later.</p>",
    },
    ...
    "agent.photo": {ZH_CN: "照片", EN: "Photo"},
    "agent.photo_optional": {
        ZH_CN: "可选：选择一张照片",
        EN: "Optional: choose a photo",
    },
    "agent.choose": {ZH_CN: "选择…", EN: "Choose…"},
    "agent.clear": {ZH_CN: "清除", EN: "Clear"},
    "agent.no_photo": {ZH_CN: "未选择照片", EN: "No photo selected"},
    ...
    "agent.workspace_subtitle": {
        ZH_CN: "上传照片或描述目标，Agent 生成候选，GIS 数据负责核验。",
        EN: "Add a photo or describe the target. Agents propose; GIS data verifies.",
    },
    ...
    "agent.choose_photo_title": {
        ZH_CN: "选择用于定位的照片",
        EN: "Choose a Photo to Geolocate",
    },
    "agent.image_filter": {
